...
[Mostly Complete] answerGenerator: this feature generates the answers to their corresponding question.

[Not attempted] QandA generator: this feature generates the next question when and answers when the user gets the question correct

[Not attempted] EXTRA: add a feature that collects a userName from the user and personalizes the 'you are correct!' prompt when the user has a successful answer.
